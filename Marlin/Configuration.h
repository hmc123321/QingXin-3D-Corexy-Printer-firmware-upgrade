...
#define CUSTOM_MACHINE_NAME "HMC's Corexy"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {   37.28, 37.28 }
    #define DEFAULT_Ki_LIST {    2.77,  2.77 }
    #define DEFAULT_Kd_LIST {  125.21,125.21 }
  #else
    #define DEFAULT_Kp   37.28
    #define DEFAULT_Ki    2.77
    #define DEFAULT_Kd  125.21
  #endif
#endif // PIDTEMP
 ...
 */
#define X_DRIVER_TYPE  TMC2208//_STANDALONE
#define Y_DRIVER_TYPE  TMC2208//_STANDALONE
